...
export const TRANSLATIONS = {
  en: {
    ...
    avgViewsPerItem: 'Avg. views per item',
    mostPopular: 'Most popular video',
    recentUploads: 'Recent uploads',
    noRecentUploads: 'No uploads yet',
    byCategory: 'Library by category',
    videosLabel: 'videos',
  ...
  ar: {
    ...
    avgViewsPerItem: 'متوسط المشاهدات لكل فيديو',
    mostPopular: 'أكثر فيديو مشاهدة',
    recentUploads: 'الإضافات الأخيرة',
    noRecentUploads: 'لا توجد إضافات بعد',
    byCategory: 'المكتبة حسب التصنيف',
    ...
    eventDate: 'التاريخ',
    eventTime: 'الوقت',
    eventNamePlaceholder: 'مثال: قداس الأحد',
